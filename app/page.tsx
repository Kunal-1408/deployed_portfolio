...
export default function Home() {
  ...
  return (
    <main className="bg-white dark:bg-neutral-900 items-center">
      ...
      <div className="flex flex-col bg mx-4 md:ml-16 pt-20">
        <h2 className="text-slate-900 font-bold text-3xl md:text-4xl lg:text-5xl pb-2">Solutions</h2>
        <h3 className="text-slate-900 text-xl md:text-2xl lg:text-3xl">
