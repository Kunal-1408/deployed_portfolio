        ...
        {active && (
          ...
          >
            <motion.div
              ...
              ref={ref}
              className="w-full max-w-[800px] h-[800px] flex flex-col bg-white dark:bg-neutral-900 sm:rounded-3xl overflow-hidden shadow-lg border-4 border-gray-200 dark:border-gray-700 relative"
            >
              <motion.button
